...
export const ConfirmDate = ({ jobDetail, setOpen, nameBtnYes, nameBtnNo }: any) => {
  const {
    register,
    handleSubmit,
    formState: { errors }
    ...
    <>
      <div className='confirmation-date__wrapper'>
        <form action='' className='confirmation-date__form'>
          {/* <CustomInput id='timeStart' label='Ngày bắt đầu tuyển' register={register} type='date'>
            {errors.timeStart?.message}
          </CustomInput>
          <CustomInput id='timeEnd' label='Ngày hết hạn tuyển' register={register} type='date'>
