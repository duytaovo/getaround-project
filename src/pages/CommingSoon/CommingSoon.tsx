...
export default function CommingSoon() {
  return (
    <main className='flex h-screen w-full flex-col items-center justify-center'>
      <h1 className='text-4xl font-extrabold tracking-widest text-gray-900'>CommingSoon</h1>
      <div className='absolute rotate-12 rounded bg-orange px-2 text-sm text-white'>Page CommingSoon</div>
