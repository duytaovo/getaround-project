...
!(function (t, e) {
  ...
  var F = {
    ...
    $ = (function (t) {
      ...
      return (
        ...
        (r.pause = function (t) {
          t || (this._isPaused = !0),
            Y.findOne('.carousel-item-next, .carousel-item-prev', this._element) && (f(this._element), this.cycle(!0)),
  ...
  function Dt(t) {
    ...
    if (l) {
      var v = Et(n)
      v === ut(n) && (v = bt(n)),
        o === et && ((g = nt), (f -= v.clientHeight - i.height), (f *= a ? 1 : -1)),
        o === ot && ((p = it), (u -= v.clientWidth - i.width), (u *= a ? 1 : -1))
    }
    var _,
      ...
      : Qt(
          (function (t) {
            var e = bt(t),
              ...
              a = -n.scrollTop
            return (
              'rtl' === vt(i || e).direction && (s += Math.max(e.clientWidth, i ? i.clientWidth : 0) - o),
  ...
  function te(t, e, n) {
    ...
    return (
      (a || (!a && !n)) &&
        (('body' !== ct(e) || Wt(r)) &&
          (l = (i = e) !== ut(i) && dt(i) ? { scrollLeft: (o = i).scrollLeft, scrollTop: o.scrollTop } : Ht(i)),
        dt(e) ? (((c = Bt(e)).x += e.clientLeft), (c.y += e.clientTop)) : r && (c.x = Rt(r))),
      {
  ...
  var oe = ie(),
    ...
    _e = (function (t) {
      ...
      return (
        ...
        (r._getConfig = function (t) {
          return (
            (t = n({}, this.constructor.Default, F.getDataAttributes(this._element), t)),
      ...
      return (
        ...
        (r._resetScrollbar = function () {
          ...
          void 0 === t
            ...
            : (F.removeDataAttribute(document.body, 'padding-right'), (document.body.style.paddingRight = t))
        }),
        ...
        (r.setElementContent = function (t, e) {
          if (null !== t)
            return 'object' == typeof e && d(e)
              ...
              : void (this.config.html
                  ? (this.config.sanitize && (e = Oe(e, this.config.allowList, this.config.sanitizeFn)),
                    (t.innerHTML = e))
                  : (t.textContent = e))
        }),
        (r.getTitle = function () {
  ...
  var Ye = { animation: 'boolean', autohide: 'boolean', delay: 'number' },
    ...
    ze = (function (t) {
      ...
      return (
        ...
        (r._getConfig = function (t) {
          return (
            (t = n({}, qe, F.getDataAttributes(this._element), 'object' == typeof t && t ? t : {})),
