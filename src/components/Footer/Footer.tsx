...
const Footer = (props: Props) => {
  return (
    // <div classNameName='p-10 bg-mainBackGroundColor border-t-[1px]'>
    //   <div classNameName='flex items-start justify-between  '>
    //     <img src='/logo-main.png' alt='logo' classNameName='fill-current bg-none h-[36px]' />

    //     <CustomSelect
    //       width='200px'
    //       defaultValue='Pháp'
    //       options={selectItems}
    //       classNameName='text-black border-none outline-none rounded-md h-10'
    //     />
    //   </div>
    //   <div classNameName='mt-8 flex text-white/70 flex-grow justify-between flex-wrap'>
    //     <div style={style} classNameName=''>
    ...
    //         </div> */}
    //   </div>
    //   <div classNameName='flex items-center justify-center mb-5'>
    //     <div>
    //       <Space>
    //         <IconButton>
    //           <TwitterIcon classNameName='text-mainColor' />
    //         </IconButton>
    //         <IconButton>
    //           <FacebookIcon classNameName='text-mainColor' />
    //         </IconButton>
    //         <IconButton>
    //           <InstagramIcon classNameName='text-mainColor' />
    //         </IconButton>
    //       </Space>
    //     </div>
    //     <div classNameName='flex items-center justify-center'>
    //       <Link to='/' classNameName='rounded-lg'>
    //         <img src={ggplay} alt='' classNameName='m-5 h-[50px] object-contain rounded-lg' />
    //       </Link>
    //       <Link to='/'>
    //         <img src={appstore} alt='' classNameName='h-[50px] object-contain ' />
    //       </Link>
    //     </div>
    //   </div>
    // </div>
    <div>
      <div
        ...
        style={{ marginBottom: '-60px', visibility: 'visible', animationName: 'fadeInUp' }}
      >
        <div className='container'>
          <div className='contact-card style2'>
            ...
            <div className='info-card style3'>
              <div className='border-line' data-bg-src='assets/img/shape/line.svg'></div>
              ...
              <div className='info-card_content'>
                ...
                <a href='https://www.google.com/maps' className='info-card_link'>
      ...
      <footer className='footer-wrapper footer-layout7' data-bg-src='assets/img/bg/footer_bg_2.jpg'>
              ...
              <div className='col-md-6 col-xl-auto'>
                <div className='widget footer-widget'>
                  ...
                  <div className='th-widget-about'>
                    ...
                    <h4 className='footer-info-title mb-15'>WE ARE AVAILABLE</h4>
                  ...
                  <div className='recent-post-wrap'>
                    <div className='recent-post'>
                      ...
                      <div className='media-body'>
                        <div className='recent-post-meta'>
                          <a href='blog.html'>
                            <i className='far fa-calendar-days'></i>22th May, 2023
                          </a>
                        </div>
                    ...
                    <div className='recent-post'>
                      ...
                      <div className='media-body'>
                        <div className='recent-post-meta'>
                          <a href='blog.html'>
                            <i className='far fa-calendar-days'></i>25th May, 2023
                          </a>
                        </div>
                        <h4 className='post-title'>
                          <a className='text-inherit' href='blog-details.html'>
                  ...
                  <div className='newsletter-widget'>
                    ...
                    <div className='footer-search-contact style2 mt-25'>
                      ...
                      <div className='footer-btn mt-10'>
                        <button type='submit' className='th-btn style3 fw-btn radius-btn'>
                          Subscribe Now<i className='fa-regular fa-arrow-right ms-2'></i>
                        </button>
                      </div>
                    </div>
                  </div>
            ...
            <div className='row align-items-center'>
              <div className='col-lg-6'>
                <p className='copyright-text'>
                  <i className='fal fa-copyright'></i> 2023<a href='https://themeforest.net/user/themeholy'>Taxiar.</a>{' '}
                  All Rights Reserved.
                </p>
              </div>
              <div className='col-lg-6'>
