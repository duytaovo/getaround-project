...
export const ItemCarousel: IItemCarousel[] = [
  {
    id: 1,
    title: 'The freedom of flexibility',
    content:
  ...
  {
    id: 2,
    title: 'The freedom of flexibilityyyyyy',
    content:
      'Get the exact kind of vehicle for your trip, and book it for the hours (or days) when you actually need it.',
    header: 'THOUSANDS OF OPTIONS',
    img: 'https://assets-global.website-files.com/5c16e90c8f6920b098f834e5/6424a42fa7a5e299086ca951_yasminehostga%20Pequena.png',
...
export const ItemCarouselAboutUS: IItemCarousel[] = [
  {
    id: 1,
  ...
  {
    id: 2,
    title: '100% digital carsharing',
    content:
      'Our proprietary Connect® technology unlocks a truly contactless experience for drivers—no waiting in line at a car rental counter, manually completing paperwork, or meeting anyone to collect keys.',
    header: 'THE CONNECT ADVANTAGE',
  ...
  },
  {
    ...
    content: `Car owners list their vehicles on Getaround, and earn extra money when guests book their vehicles for trips. It's a two-sided marketplace that benefits everyone, and gives people access to transportation.`,
    header: 'GETAROUND COMMUNITY',
