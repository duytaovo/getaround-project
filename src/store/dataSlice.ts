...
const data: IdynamicData<string> = {
  ...
  'txt-contentSlider-shareACar-content':
  ...
  'bodyCarTop_txt-bodyCard-shareACar-content':
  ...
  txt_CardBodyParner_community_content:
  ...
  txt_topGettingStarted_community_content:
  ...
  img_gettingStarted_hostCommunity:
  ...
  txt_GettingStarted_community_contentNailTheBasic:
  ...
  txt_GettingStarted_community_contentBusiness:
